...
由于 JS 语言的擅长方向并不是数学研究，为了便于演示，我会使用 Python 的专业数学库 [SymPy](https://www.sympy.org/) 来成文。不过不用担心，这里不会使用 Python 里深奥的语法，且都尽量附上 JS 的实现。比起更复杂的高数，学习 Python 并会不占用你半天以上的精力。
